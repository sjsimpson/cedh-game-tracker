...
// TODO: Figure out how to use TanstackRouter built-in "active"
// Currently I am passing in "current" (see /apps/web/routes/__root.tsx)
// But (I think) I would prefer to use the native tanstack "data-status=active"
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  let classes = clsx(
    ...
    // Active
    "data-[status=active]:bg-zinc-950/5 data-[slot=icon]:*:data-[status=active]:fill-zinc-950",
    // Dark mode
    "dark:text-white dark:data-[slot=icon]:*:fill-zinc-400",
    "dark:data-[hover]:bg-white/5 dark:data-[slot=icon]:*:data-[hover]:fill-white",
    "dark:data-[status=active]:bg-white/5 dark:data-[slot=icon]:*:data-[status=active]:fill-white",
  );
